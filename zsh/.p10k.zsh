# Generated by Powerlevel10k configuration wizard on 2023-07-31 at 13:29 IST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 47269.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, round separators, round heads, slanted tails, 2 lines, dotted, right frame,
# dark-ornaments, sparse, many icons, fluent, instant_prompt=off.
